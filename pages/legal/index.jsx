...
export default function Legal() {
    return (
        <main className={styles.legalNoticeWrapper}>
            <h1 className={styles.centered}>Mentions légales :</h1>
            <h2>
                <span className={styles.underlined}>Définitions</span>
            </h2>
            <p>
                <span className={styles.underlined}>Client : </span>tout
                professionnel ou personne physique capable au sens des articles
                1123 et suivants du Code civil, ou personne morale, qui visite
                le Site objet des présentes conditions générales.
            </p>
            <p>
                <span className={styles.underlined}>
                    Prestations et Services :{' '}
                </span>
                <a href="https://www.techquest.fr">https://www.techquest.fr</a>{' '}
                met à disposition des Clients :
            </p>
            <p>
                <span className={styles.underlined}>Contenu : </span>
            ...
            <p>
                ...
                l'ensemble des données personnelles susceptibles d'être détenues
                par{' '}
                <a href="https://www.techquest.fr">https://www.techquest.fr</a>{' '}
            ...
            <p>
                <span className={styles.underlined}>Utilisateur : </span>
            ...
            <p>
                ...
                <span>Malfilâtre Maxime - maxime.malfilatre@gmail.com</span>
                <br />
                <strong>Hébergeur : </strong>
                <span>
                    1and1-7 place de la Gare 57200 Sarreguemines 0970 808 911
                </span>
                <br />
            ...
            <p>
                ...
                en aucune manière réutiliser, céder ou exploiter pour son propre
            ...
            <p>
                ...
                logos, vidéos, icônes et sons. Toute reproduction,
            ...
            <p>
                <span></span> - DPO, <span>Malfilâtre </span>
                <br />
                <span>13 allée du carretey 33610 Cestas.</span>
            </p>
            <p>
            ...
            <p>
                ...
                soient pas communiquées à des personnes non autorisées.
            ...
            <p>
                ...
                <a href="https://www.techquest.fr"> https://www.techquest.fr</a>
                ,nous collectons les données suivantes qui sont indispensables
                au fonctionnement du service , et qui seront conservées pendant
                une période maximale de <span>-</span> mois après la fin de la
                relation contractuelle: <br />
                <span>- </span>
            </p>
            <p>
                <a href="https://www.techquest.fr">
                ...
                collecte également des informations qui améliorent l'expérience
                utilisateur et offre des astuces contextualisées: <br />
                <span> - </span>
            </p>
            <p>
                {' '}
                Ces données sont conservées pendant un maximum de <span>
                    -
                </span>{' '}
                mois après la fin de la relation contractuelle.
            </p>
            <h3>
                <span className={styles.underlined}>
            ...
            <p>
                ...
                leur compte et à leur fournir toutes les informations
            ...
            <span className={styles.underlined}>Sécurité</span>
            <p>
            ...
            <h4>
                <span className={styles.underlined}>9.1. « COOKIES »</span>
            </h4>
            <p>
            ...
            <p>
                ...
                navigateur pour qu'il lui permette de décider s'il souhaite ou
                non les accepter de manière à ce que des Cookies soient
                enregistrés dans le terminal ou, au contraire, qu'ils soient
                rejetés, soit systématiquement, soit selon leur émetteur.
                L'Utilisateur peut également configurer son logiciel de
                navigation de manière à ce que l'acceptation ou le refus des
                Cookies lui soient proposés ponctuellement, avant qu'un Cookie
            ...
            <p>
                ...
                navigation et son expérience sur le Site peuvent être limitées.
                Cela pourrait également être le cas lorsque,{' '}
                <a href="https://www.techquest.fr"> https://www.techquest.fr</a>{' '}
                ou l'un de ses prestataires ne peut pas reconnaître, à des fins
                de compatibilité technique, le type de navigateur utilisé par le
            ...
            <p>
                ...
                correspondantes, y compris l'adresse IP de l'Utilisateur) dans
                un pays étranger.
            </p>
            <p>
            ...
            <p>
                ...
                tribunaux compétents de <span>Bordeaux</span>
            </p>
        </main>
    )
}
