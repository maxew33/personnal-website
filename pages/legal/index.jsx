...
export default function Legal() {
    return (
        <main className={styles.legalNoticeWrapper}>
                <h3 className={styles.centered}>Mentions légales :</h3>
                <h3>
                    <span className={styles.underlined}>Définitions</span>
                </h3>
                <p>
                    <span className={styles.underlined}>Client : </span>tout
                    professionnel ou personne physique capable au sens des
                    articles 1123 et suivants du Code civil, ou personne morale,
                ...
                <p>
                    ...
                    Ensemble des éléments constituants l'information présente
                ...
                <p>
                    ...
                    physiques auxquelles elles s'appliquent » (article 4 de la
                ...
                <p>
                    ...
                    <span>
                        1and1-7 place de la Gare 57200 Sarreguemines 0970 808
                        911
                    </span>
                    <br />
                ...
                <p>
                    ...
                    est sont proposé par{' '}
                    <a href="https://marozed.com">Marozed</a>
                </p>
                <h4>
                    <span className={styles.underlined}>
                ...
                <p>
                    ...
                    Réglementations Internationales applicables. Le Client ne
                    peut en aucune manière réutiliser, céder ou exploiter pour
                    son propre compte tout ou partie des éléments ou travaux du
                    Site.
                </p>
                <p>
                ...
                <h4>
                    <span className={styles.underlined}>
                        4. Limitations contractuelles sur les données
                        techniques.
                    </span>
                </h4>
                <p>
                ...
                <ul>
                    <li>
                        ...
                        par l'utilisateur : données de connexion et
                        d'utilisation du Site, facturation, historique des
                        commandes, etc.
                    </li>
                    <li>
                        {' '}
                        ...
                        pour la navigation, l'adresse IP, le mot de passe
                        (hashé)
                    </li>
                    <li>
                        {' '}
                ...
                <p>
                    ...
                    conservées pendant une période maximale de <span>
                        -
                    </span>{' '}
                    mois après la fin de la relation contractuelle: <br />
                    <span>- </span>
                </p>
                <p>
                    <a href="https://www.techquest.fr">
                ...
                <p>
                    {' '}
                    Ces données sont conservées pendant un maximum de{' '}
                    <span>-</span> mois après la fin de la relation
                    contractuelle.
                </p>
                <h4>
                    <span className={styles.underlined}>
                ...
                <p>
                    ...
                    empêcher l'accessibilité à tout ou partie des Services
